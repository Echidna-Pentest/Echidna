...
# [Echidna]
# name: The ip neigh command manipulates neighbour objects that establish bindings between protocol addresses and link layer addresses for hosts sharing the same link. 
# template: ip neigh
# template: ip -4 neigh
# pattern: ip (-4 )*n.*
# [end]
